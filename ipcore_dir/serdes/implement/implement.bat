...
xst -ifn xst.scr
move serdes_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\serdes_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc serdes_exdes.ucf serdes_exdes

echo 'Running map'
map -timing serdes_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm serdes_exdes -w routed.ncd routed.vhd
cd ..
