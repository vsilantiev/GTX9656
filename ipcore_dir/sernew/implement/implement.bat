...
xst -ifn xst.scr
move sernew_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\sernew_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc sernew_exdes.ucf sernew_exdes

echo 'Running map'
map -timing sernew_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm sernew_exdes -w routed.ncd routed.vhd
cd ..
