...
xst -ifn xst.scr
move serdes2_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\serdes2_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc serdes2_exdes.ucf serdes2_exdes

echo 'Running map'
map -timing serdes2_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm serdes2_exdes -w routed.ncd routed.vhd
cd ..
