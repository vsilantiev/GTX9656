...
xst -ifn xst.scr
move testpll_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\testpll_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc testpll_exdes.ucf testpll_exdes

echo 'Running map'
map -timing -pr b testpll_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm testpll_exdes -w routed.ncd routed.vhd
cd ..
