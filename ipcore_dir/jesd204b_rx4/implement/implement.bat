...
COPY jesd204b_rx4_exdes.ngc .\results
cd .\results

REM Run ngdbuild

ngdbuild -uc ..\..\example_design\jesd204b_rx4_exdes.ucf -p xc7a200t-fbg676-2 jesd204b_rx4_exdes.ngc jesd204b_rx4_exdes.ngd
...
ECHO 'Running NGD'
map -register_duplication on -logic_opt on -timing -ol high -p xc7a200t-fbg676-2 -o mapped.ncd jesd204b_rx4_exdes.ngd
...
netgen -ofmt vhdl -sim -dir . -tm jesd204b_rx4_exdes -w routed.ncd routed.vhd
